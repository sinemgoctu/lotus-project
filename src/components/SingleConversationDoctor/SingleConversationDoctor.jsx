...
import "./SingleConversationDoctor.css";

const SingleConversationDoctor = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await fetch(
        "https://lotusproject.azurewebsites.net/api/messages/doctor",
        {
          method: "POST",
          headers: {
  ...
  return (
    <Container maxWidth="md" className="single-conversation-doctor-container">
      <Box my={4} className="single-conversation-doctor-header">
        ...
        <Box my={4} className="single-conversation-doctor-messages">
          <List>
            {messages.map((message) => (
              ...
              >
                <Paper
                  elevation={3}
                  className="single-conversation-doctor-message"
                  sx={{
                    backgroundColor:
        ...
        <Box my={4}>
          ...
          <Button
            ...
            className="single-conversation-doctor-submit"
          >
            Gönder
          </Button>
        </Box>
...
export default SingleConversationDoctor;
